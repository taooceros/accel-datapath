...
require_literal_in_file "${CRATE_DIR}/src/async_session.rs" 'open_config' 'source_async_session_open_config'
...
require_literal_in_file "${CRATE_DIR}/src/async_direct/monitor.rs" 'tokio::select!' 'source_async_direct_monitor_idle_wakeup_select'
