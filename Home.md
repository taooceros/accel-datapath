# Tonic DSA knowledge vault

Open this repository root as the Obsidian vault. Active navigation stays small; historical material lives under `archive/`.
...
- Keep current state in `notes/now.md` when needed.
